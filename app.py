...
@st.cache_data
def load_data():
    csv_path = os.path.join(os.path.dirname(__file__), "MELBOURNE_HOUSE_PRICES_LESS.csv")
...
@st.cache_resource
def load_model():
    model_path = os.path.join(os.path.dirname(__file__), "xgboost_house_price_model.pkl")
...
with col2:
    st.subheader("🔮 The Predicted House Price")
...
with col1:
    st.markdown("### Distribution Graph of House Prices")
...
st.markdown("---")
st.markdown("© 2025 House Price Predictor | Built By Swarnangkur Dey")